<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" class="newbuildBreadcrumb">
            ...
            <el-breadcrumb-item :to="{path: '/control/newbuild'}">创建项目</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="newbuildBox">
            ...
            <div class="newbuildLeftBox newbuildRightBox">
                ...
                <div class="newbuildInputBox newbuildUploadBox">
                    ...
                    <el-upload
                            ...
                            :auto-upload='false'>
                        <div class="el-upload__text">电视剧/网剧剧本需将所有集合并于同一文档中进行上传<br>
                            电视剧/网剧剧本需要在文本内容中包含xxx集<br>（如：第1集，第一集）等字样。<br><em>点击上传</em></div>
                    </el-upload>
                </div>
            </div>
            ...
            <div class="formatBox">
                <div class="formatTopBox">
                    ...
                    <p class="txt">段首格式选择</p>
                    <span class="line"></span>
                </div>
                <p class="formatDesc">*选择合适的剧本样式可以有效的提升剧本的识别率，请选择最符合您剧本样式的段首格式</p>
                <div class="newbuildFormat">
                    <div name="WB" :class="[form.formatChoiceId == 'WB'?'active':'']" @click="activeChange('WB')">
                        <span class="newbuildFormatTop">常规文本格式</span>
                    ...
                    <div name="WB1" :class="[form.formatChoiceId == 'WB1'?'active':'']" @click="activeChange('WB1')">
                    ...
                    <div name="WB2" :class="form.formatChoiceId == 'WB2'?'active':''" @click="activeChange('WB2')">
                        <span class="newbuildFormatTop">文本格式2</span>
                        <div class="newbuildFormatContent">
                            <p>1.动物园外</p>
                            <p class="br left">人：张三 李四</p>
                            <p>1.日  内 动物园</p>
                            <p class="br left">人物：张三 李四</p>
                            <p>2-1     动物园。夜。外。</p>
                            <p class="br left">（人物：张三   李四）</p>
                            <p>1、动物园</p>
                            <p class="br left">人物 张三 李四 王五</p>
                            <p>1   动物园  内  日</p>
                            <p class="br left">人物：张三、李四、王五；</p>
                            <p>一、动物园 夜 内</p>
                            <p class="br left">人物：张三 </p>
                        </div>
                    </div>
                    <div name="WB3" :class="form.formatChoiceId == 'WB3'?'active':''" @click="activeChange('WB3')">
                        ...
                        <div class="newbuildFormatContent">
                            ...
                            <p>时间：夜</p>
                            <p>地点：动物园</p>
                            <p class="br">人 物：张三、李四、王五。</p>
                            <p>第三场</p>
                            <p>场景：动物园</p>
                            <p>人物：张三，李四</p>
                        </div>
                    </div>
                    <div name="WB4" :class="[form.formatChoiceId == 'WB4'?'active':'',,'formatNd']" @click="activeChange('WB4')">
                        <span class="newbuildFormatTop">文本格式4</span>
                        <div class="newbuildFormatContent">
                            <p>1.内景 动物园 夜  人物：张三  李四</p>
                            <p>1-1日 内 动物园  人：张三、李四、王五</p>
                            <p>2  动物园  日  外    人物   张三   李四</p>
                        </div>
                    </div>
                    <div name="BG1" :class="[form.formatChoiceId == 'BG1'?'active':'','formatTable']" @click="activeChange('BG1')">
                    ...
                    <div name="BG2" :class="[form.formatChoiceId == 'BG2'?'active':'','formatTable']" @click="activeChange('BG2')">
    ...
    export default {
        ...
        methods:{
            ...
            getFile(e){
                ...
                this.form.play = deviceFile[0];
                this.play_name = deviceFile[0].name;
            },
            ...
            submit () {
                ...
                if(this.form.play != ''){
                    if(this.form.name != '' && this.form.director != '' && this.form.type != ''){
                        ...
                        axios({
                            ...
                            if(response.data.msg == 'ok'){
                                ...
                                // this.$router.push('/preview?play_id='+this.play_id+'&project_id='+this.project_id)
...
<style>
    ...
    /*上传框*/
    .newbuildBox .newbuildRightBox .uploadFile .el-upload-dragger{
        width:330px;
        height:116px;
        border-radius:6px;
    }

    .newbuildBox .newbuildRightBox .uploadFile .el-upload-dragger:hover{
        border-color: rgba(255,105,14,1);
    }

    .newbuildBox .newbuildRightBox .uploadFile .el-upload-dragger .el-upload__text{
        font-size: 12px;
        margin-top: 12px;
        line-height: 24px;
    }

    .newbuildBox .newbuildRightBox .uploadFile .el-upload-dragger .el-upload__text em{
...
<style scoped>
    *{
    ...
    .newbuildBox .newbuildRightBox .uploadFile{
        margin-top: 16px;
        width:330px;
        height:160px;
        border-radius:6px;
    ...
    .newbuildBox .newbuildFormat>div{
        width:250px;
        height:380px;
        background:rgba(255,255,255,1);
    ...
    .newbuildBox .newbuildFormat>div.active{
        border-color: rgba(255,166,37,1);
        background:rgba(245,245,245,1);
    }

    .newbuildBox .newbuildFormat>.formatNd{
        height: 310px;
    }

    .newbuildBox .newbuildFormat>.formatTable{
        height: 310px;
        width: 380px;
    }
    ...
    .newbuildBox .newbuildFormat .newbuildFormatContent p.left{
        padding-left: 4px;
    }
